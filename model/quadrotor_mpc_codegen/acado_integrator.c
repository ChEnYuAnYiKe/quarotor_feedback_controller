...
{ 7.4999999999999997e-03, 1.6160254037844386e-02, 
-1.1602540378443859e-03, 7.4999999999999997e-03 };
...
rk_diffsNew2[(i * 14) + (run1)] += + rk_diffK[i * 2]*(real_t)1.4999999999999999e-02 + rk_diffK[i * 2 + 1]*(real_t)1.4999999999999999e-02;
}
}
...
for (i = 0; i < 10; ++i)
{
rk_diffsNew2[(i * 14) + (run1 + 10)] = + rk_diffK[i * 2]*(real_t)1.4999999999999999e-02 + rk_diffK[i * 2 + 1]*(real_t)1.4999999999999999e-02;
}
}
rk_eta[0] += + rk_kkk[0]*(real_t)1.4999999999999999e-02 + rk_kkk[1]*(real_t)1.4999999999999999e-02;
rk_eta[1] += + rk_kkk[2]*(real_t)1.4999999999999999e-02 + rk_kkk[3]*(real_t)1.4999999999999999e-02;
rk_eta[2] += + rk_kkk[4]*(real_t)1.4999999999999999e-02 + rk_kkk[5]*(real_t)1.4999999999999999e-02;
rk_eta[3] += + rk_kkk[6]*(real_t)1.4999999999999999e-02 + rk_kkk[7]*(real_t)1.4999999999999999e-02;
rk_eta[4] += + rk_kkk[8]*(real_t)1.4999999999999999e-02 + rk_kkk[9]*(real_t)1.4999999999999999e-02;
rk_eta[5] += + rk_kkk[10]*(real_t)1.4999999999999999e-02 + rk_kkk[11]*(real_t)1.4999999999999999e-02;
rk_eta[6] += + rk_kkk[12]*(real_t)1.4999999999999999e-02 + rk_kkk[13]*(real_t)1.4999999999999999e-02;
rk_eta[7] += + rk_kkk[14]*(real_t)1.4999999999999999e-02 + rk_kkk[15]*(real_t)1.4999999999999999e-02;
rk_eta[8] += + rk_kkk[16]*(real_t)1.4999999999999999e-02 + rk_kkk[17]*(real_t)1.4999999999999999e-02;
rk_eta[9] += + rk_kkk[18]*(real_t)1.4999999999999999e-02 + rk_kkk[19]*(real_t)1.4999999999999999e-02;
for (i = 0; i < 10; ++i)
{
for (j = 0; j < 10; ++j)
{
